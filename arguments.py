...
def get_args():
    ...
    parser.add_argument('--entity-mp', action='store_true', help='enable entity message passing')   # store_true --> false
    parser.add_argument('--identity-size', default=0, type=int, help='size of identity vector')

    # trainings
    parser.add_argument('--seed', type=int, default=None, help='random seed (default: None)')
    parser.add_argument('--num-processes', type=int, default=4, help='how many training CPU processes to use (default: 32)')
    ...
    parser.add_argument('--arena-size', type=int, default=3, help='size of arena')   # default=1

    # evaluation
    parser.add_argument('--num-eval-episodes', type=int, default=10, help='number of episodes to evaluate with')   #30
    parser.add_argument('--dist-threshold', type=float, default=0.05, help='distance within landmark is considered covered (for simple_spread)')
    ...
    parser.add_argument('--num-mini-batch', type=int, default=1, help='number of batches for ppo (default: 32)')
    ...
    # parser.add_argument('--load-dir', default="../marlsave/save_new/tmp_old/ep0.pt", help='filename to load all policies from')
    parser.add_argument('--load-dir', default="./marlsave/save_new/tmp/ep12000.pt", help='filename to load all policies from')
    # parser.add_argument('--load-dir', default="./marlsave/save_new/multipoint/ep9980.pt", help='filename to load all policies from')
